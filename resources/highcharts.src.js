...
(function (root, factory) {
    if (typeof module === 'object' && module.exports) {
        ...
        hasSVG = (doc && doc.createElementNS && !!doc.createElementNS(SVG_NS, 'svg').createSVGRect)||doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"),
    ...
    Highcharts.chart = function (a, b, c) {
        ...
        isReadyToRender: function () {
				var chart = this;
				if (chart.options.chart.forExport) return true;
